...
class User extends Authenticatable
{
    ...
    /**
     * Check if the user can access the specific Business Location
     *
     * @return bool
     */

    public static function can_user_access_this_location($location_id, $business_id, $user_id)
    {
        $permitted_locations = self::permitted_locations_for_sync($business_id, $user_id);
    ...
    /**
     * Check for permitted locations in sync(Business Controller).
     *
     * @return array
     */

    public static function permitted_locations_for_sync($business_id, $user_id)
    {
