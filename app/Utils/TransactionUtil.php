...
class TransactionUtil extends Util
{
    ...
    public function createOrUpdateSellLinesApi($transaction, $products, $location_id, $return_deleted = false, $status_before = null, $extra_line_parameters = [], $uf_data = true)
    {
        $lines_formatted = [];
        $modifiers_array = [];
        $edit_ids = [0];
