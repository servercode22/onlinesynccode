...
class ManageUserController extends Controller
{
    ...
    {
        $business_id = request()->session()->get('user.business_id');
        $business_key = DB::table('business')->where('id',$business_id)->first();
        $location_keys = DB::table('business_locations')->where('business_id',$business_id)->get();
    
        return view('manage_user.secret_key')->with(compact('business_key','location_keys'));        
    }
}
