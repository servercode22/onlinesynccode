...
@section('content')
    ...
    <section class="content">
        <div class="row">
            <h1 class="text-center">@lang( 'lang_v1.secret_keys' )</h1>

            <div class="col-md-12" style="margin-left: 15%">
                <h3>Business Pin:</h3>
                <br>
                <strong><span class="text-primary">{{$business_key->secret_key}}</span></strong><br>
            ...
            <div class="col-md-12" style="margin-left: 15%">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        @foreach ($location_keys as $keys)
                        <tr>
                            <td>{{$keys->name}}</td>
                            <td><span class="text-bold text-primary">{{$keys->secret_key}}</span></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
