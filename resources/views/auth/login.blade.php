...
{{-- <div class="col-lg-2 col-md-2"></div> --}}
    <div class="login-form col-lg-12 col-md-12 col-xs-8 right-col-content">
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-8 login-key">
            ...
            <div class="row">
                <div class="col-lg-2"></div>
                <div class="col-lg-8 login-title">
                    ADMIN PANEL
                  </div>
                  <div class="col-lg-2"></div>
            </div>
        ...
        <form method="POST" action="{{ route('login') }}" id="login-form">
            ...
            <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
                ...
                @endphp
                <input style="" id="username" type="text" class="form-control" name="username" value="{{ $username }}" required autofocus placeholder="@lang('lang_v1.username')">
                <span class="fa fa-user form-control-feedback"></span>
                @if ($errors->has('username'))
                    <span class="help-block">
                        <strong style="color: #f72323!important">{{ $errors->first('username') }}</strong>
                    </span>
                @endif
            </div>
            <div class="form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                @if ($errors->has('password'))
                    <span class="help-block">
                        <strong  style="color: #f72323!important">{{ $errors->first('password') }}</strong>
                    </span>
                @endif
            </div>
