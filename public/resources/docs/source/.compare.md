...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"voluptatem","ip_address":"eligendi","latitude":"et","longitude":"laborum"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"provident","latitude":"saepe","longitude":"ad"}'
...
<!-- START_1550e6b307f2bd0697fcee61ef4d157e -->
## List brands
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/list-brands" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-brands"
);
...
### HTTP Request
`GET connector/api/list-brands`


<!-- END_1550e6b307f2bd0697fcee61ef4d157e -->
...
<!-- START_67de07f14831d1ae9f31f5ab56c252d5 -->
## connector/api/business-location-verify
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/business-location-verify" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/business-location-verify"
);
...
### HTTP Request
`GET connector/api/business-location-verify`


<!-- END_67de07f14831d1ae9f31f5ab56c252d5 -->
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=quaerat&follow_up_type=incidunt&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=quasi&biz_name=laboriosam&mobile_num=18&contact_id=laudantium&order_by=non&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"nesciunt","mobile_name":"est","call_type":"call","start_time":"saepe","end_time":"numquam","duration":"tenetur"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":424.09384,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":76120.44933,"total_card_slips":1,"total_cheques":9,"closing_note":"iste","transaction_ids":"1,2,3"}'
...
<!-- START_d1c50603b09007a96d6701c5a75f373c -->
## List contact
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/list-contacts?type=et&name=quia&biz_name=harum&mobile_num=2&contact_id=ducimus&order_by=quia&direction=repellat&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-contacts"
);
...
### HTTP Request
`GET connector/api/list-contacts`
...
<!-- END_d1c50603b09007a96d6701c5a75f373c -->
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=aut&name=pariatur&biz_name=et&mobile_num=1&contact_id=rerum&order_by=omnis&direction=vero&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"sint","prefix":"voluptatem","first_name":"perspiciatis","middle_name":"unde","last_name":"minus","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"quasi","address_line_2":"accusantium","city":"ut","state":"aspernatur","country":"quo","zip_code":"autem","customer_group_id":"vitae","contact_id":"iste","dob":"2000-06-13","custom_field1":"qui","custom_field2":"exercitationem","custom_field3":"dolorem","custom_field4":"odit","email":"voluptas","shipping_address":"soluta","position":"nostrum","opening_balance":0,"source_id":2,"life_stage_id":11,"assigned_to":[]}'
...
let body = {
    ...
    "address_line_2": "accusantium",
    "city": "ut",
    "state": "aspernatur",
    "country": "quo",
    "zip_code": "autem",
    "customer_group_id": "vitae",
    "contact_id": "iste",
    "dob": "2000-06-13",
    "custom_field1": "qui",
    "custom_field2": "exercitationem",
    "custom_field3": "dolorem",
    "custom_field4": "odit",
    "email": "voluptas",
    "shipping_address": "soluta",
    "position": "nostrum",
    "opening_balance": 0,
    "source_id": 2,
    "life_stage_id": 11,
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"quia","prefix":"eveniet","first_name":"explicabo","middle_name":"fugit","last_name":"et","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"velit","address_line_2":"molestias","city":"expedita","state":"eos","country":"eius","zip_code":"doloribus","customer_group_id":"voluptatum","contact_id":"tenetur","dob":"2000-06-13","custom_field1":"sint","custom_field2":"sit","custom_field3":"in","custom_field4":"voluptatem","email":"repudiandae","shipping_address":"ea","position":"dolores","opening_balance":10.3,"source_id":18,"life_stage_id":4,"assigned_to":[]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":1,"card_number":"fugiat","card_holder_name":"sunt","card_transaction_number":"amet","card_type":"qui","card_month":"magnam","card_year":"numquam","card_security":"perspiciatis","transaction_no_1":"numquam","transaction_no_2":"porro","transaction_no_3":"qui","cheque_number":"voluptate","bank_account_number":"eligendi","note":"sint"}'
...
let body = {
    ...
    "account_id": 1,
    "card_number": "fugiat",
    "card_holder_name": "sunt",
    "card_transaction_number": "amet",
    "card_type": "qui",
    "card_month": "magnam",
    "card_year": "numquam",
    "card_security": "perspiciatis",
    "transaction_no_1": "numquam",
    "transaction_no_2": "porro",
...
<!-- START_15a0f8bebcae8ef9b4e85be08e485fc5 -->
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/list-expense_categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-expense_categories"
);
...
### HTTP Request
`GET connector/api/list-expense_categories`


<!-- END_15a0f8bebcae8ef9b4e85be08e485fc5 -->
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=voluptas&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":11558631.75,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":2,"expense_for":13,"contact_id":8,"expense_category_id":19,"expense_sub_category_id":14,"additional_notes":"odit","is_refund":0,"is_recurring":0,"recur_interval":15,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"id","recur_repetitions":15,"payment":[{"amount":453.13,"method":"cash","account_id":14,"card_number":"omnis","card_holder_name":"et","card_transaction_number":"corrupti","card_type":"perferendis","card_month":"tenetur","card_year":"dolor","card_security":"qui","transaction_no_1":"rerum","transaction_no_2":"neque","transaction_no_3":"et","note":"ratione","cheque_number":"eum"}]}'
    ...
    "payment": [
        {
            ...
            "card_type": "perferendis",
            "card_month": "tenetur",
            "card_year": "dolor",
            "card_security": "qui",
            "transaction_no_1": "rerum",
            "transaction_no_2": "neque",
            "transaction_no_3": "et",
            "note": "ratione",
            "cheque_number": "eum"
        }
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":1805.2357,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":14,"expense_for":18,"contact_id":15,"expense_category_id":2,"expense_sub_category_id":3,"additional_notes":"molestiae","is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"illum","recur_repetitions":16,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=quia&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=in&assigned_to=qui&status=quas&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":16,"visit_to":"ipsam","visit_address":"sint","assigned_to":16,"visit_on":"2021-12-28 17:23:00","visit_for":"maxime"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"adipisci","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"quam","photo":"molestiae"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "adipisci",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=unde&order_direction=nihil&brand_id=nihil&category_id=laudantium&sub_category_id=voluptatem&location_id=1&selling_price_group=quo&send_lot_detail=voluptatum&name=quia&sku=placeat&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "order_by": "unde",
    "order_direction": "nihil",
    "brand_id": "nihil",
    "category_id": "laudantium",
    "sub_category_id": "voluptatem",
    "location_id": "1",
    "selling_price_group": "quo",
    "send_lot_detail": "voluptatum",
    "name": "quia",
    "sku": "placeat",
    "per_page": "10",
};
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=repellendus&send_lot_detail=aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "selling_price_group": "repellendus",
    "send_lot_detail": "aut",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
<!-- START_60639f9e2e0b44dc63cec7b009269efe -->
## connector/api/list-products
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-products" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-products"
);
...
### HTTP Request
`GET connector/api/list-products`


<!-- END_60639f9e2e0b44dc63cec7b009269efe -->

<!-- START_be3d82f9faf002c0df1e8b271c0f83d2 -->
## connector/api/list-modifiers
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-modifiers" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-modifiers"
);
...
### HTTP Request
`GET connector/api/list-modifiers`


<!-- END_be3d82f9faf002c0df1e8b271c0f83d2 -->
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=est&location_id=1&brand_id=eos&category_id=quia&sub_category_id=non&not_for_selling=qui&name=distinctio&sku=ut&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=laudantium&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=commodi&service_staff_id=optio&shipping_status=ordered&source=consequatur&only_subscriptions=reprehenderit&send_purchase_details=ea&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "commodi",
    "service_staff_id": "optio",
    "shipping_status": "ordered",
    "source": "consequatur",
    "only_subscriptions": "reprehenderit",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":13,"transaction_date":"2020-07-22 15:48:29","invoice_no":"explicabo","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":2,"discount_amount":10,"discount_type":"fixed","sale_note":"autem","staff_note":"eligendi","commission_agent":1,"shipping_details":"Express Delivery","shipping_address":"voluptatem","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":11,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"deserunt","recur_repetitions":9,"rp_redeemed":11,"rp_redeemed_amount":13.5,"types_of_service_id":16,"service_custom_field_1":"nihil","service_custom_field_2":"voluptas","service_custom_field_3":"consequuntur","service_custom_field_4":"saepe","service_custom_field_5":"et","service_custom_field_6":"perferendis","round_off_amount":124.23,"table_id":14,"service_staff_id":16,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":14,"note":"vero"}],"payments":[{"amount":453.13,"method":"cash","account_id":6,"card_number":"blanditiis","card_holder_name":"cum","card_transaction_number":"praesentium","card_type":"et","card_month":"et","card_year":"facilis","card_security":"cum","transaction_no_1":"possimus","transaction_no_2":"fugit","transaction_no_3":"qui","bank_account_number":"accusamus","note":"rerum","cheque_number":"asperiores"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "deserunt",
            "recur_repetitions": 9,
            "rp_redeemed": 11,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 16,
            "service_custom_field_1": "nihil",
            "service_custom_field_2": "voluptas",
            "service_custom_field_3": "consequuntur",
            "service_custom_field_4": "saepe",
            "service_custom_field_5": "et",
            "service_custom_field_6": "perferendis",
            "round_off_amount": 124.23,
            "table_id": 14,
            "service_staff_id": 16,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "method": "cash",
                    "account_id": 6,
                    "card_number": "blanditiis",
                    "card_holder_name": "cum",
                    "card_transaction_number": "praesentium",
                    "card_type": "et",
                    "card_month": "et",
                    "card_year": "facilis",
                    "card_security": "cum",
                    "transaction_no_1": "possimus",
                    "transaction_no_2": "fugit",
                    "transaction_no_3": "qui",
                    "bank_account_number": "accusamus",
                    "note": "rerum",
                    "cheque_number": "asperiores"
                }
            ]
        }
    ]
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=autem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":5,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":1,"discount_amount":10,"discount_type":"fixed","sale_note":"et","source":"iusto","staff_note":"porro","is_suspend":false,"commission_agent":19,"shipping_details":"Express Delivery","shipping_address":"est","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":19,"pay_term_number":3,"pay_term_type":"months","is_recurring":0,"recur_interval":9,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"non","recur_repetitions":11,"rp_redeemed":10,"rp_redeemed_amount":13.5,"types_of_service_id":13,"service_custom_field_1":"ex","service_custom_field_2":"natus","service_custom_field_3":"magnam","service_custom_field_4":"quibusdam","service_custom_field_5":"est","service_custom_field_6":"rerum","round_off_amount":0.5,"table_id":12,"service_staff_id":20,"change_return":0,"change_return_id":19,"products":[{"sell_line_id":15,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":13,"discount_amount":0,"discount_type":"percentage","sub_unit_id":8,"note":"accusantium"}],"payments":[{"payment_id":6,"amount":453.13,"method":"cash","account_id":19,"card_number":"in","card_holder_name":"quo","card_transaction_number":"voluptas","card_type":"veniam","card_month":"inventore","card_year":"architecto","card_security":"culpa","transaction_no_1":"et","transaction_no_2":"eos","transaction_no_3":"perferendis","note":"debitis","cheque_number":"neque","bank_account_number":"ut"}]}'
...
let body = {
    ...
    "service_custom_field_1": "ex",
    "service_custom_field_2": "natus",
    "service_custom_field_3": "magnam",
    "service_custom_field_4": "quibusdam",
    "service_custom_field_5": "est",
    "service_custom_field_6": "rerum",
    ...
    "payments": [
        {
            ...
            "account_id": 19,
            "card_number": "in",
            "card_holder_name": "quo",
            "card_transaction_number": "voluptas",
            "card_type": "veniam",
            "card_month": "inventore",
            "card_year": "architecto",
            "card_security": "culpa",
            "transaction_no_1": "et",
            "transaction_no_2": "eos",
            "transaction_no_3": "perferendis",
            "note": "debitis",
            "cheque_number": "neque",
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/aut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":3,"transaction_date":"2020-5-7 15:20:22","invoice_no":"et","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":20,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":1,"shipping_status":"ordered","delivered_to":"veniam"}'
...
<!-- START_70741b303346d81bfc257ea12a5be4a4 -->
## List taxes
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/list-tax_rates" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-tax_rates"
);
...
### HTTP Request
`GET connector/api/list-tax_rates`


<!-- END_70741b303346d81bfc257ea12a5be4a4 -->
...
<!-- START_299ec708eb904b357cc26ad3daa17767 -->
## connector/api/list-categories
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-categories" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-categories"
);
...
### HTTP Request
`GET connector/api/list-categories`


<!-- END_299ec708eb904b357cc26ad3daa17767 -->
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=occaecati" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
<!-- START_1c80989d05d8cb5de6a5d012ec77bf27 -->
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/list-types_of_services" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-types_of_services"
);
...
### HTTP Request
`GET connector/api/list-types_of_services`


<!-- END_1c80989d05d8cb5de6a5d012ec77bf27 -->
...
<!-- START_d55bc5867cd8e8e507f52dbc800fcbb3 -->
## connector/api/list-units
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-units" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-units"
);
...
### HTTP Request
`GET connector/api/list-units`


<!-- END_d55bc5867cd8e8e507f52dbc800fcbb3 -->
...
<!-- START_14f8df7704483f3508a87b00489de7e2 -->
## connector/api/owner-id/{id}
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/owner-id/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/owner-id/1"
);
...
### HTTP Request
`GET connector/api/owner-id/{id}`


<!-- END_14f8df7704483f3508a87b00489de7e2 -->

<!-- START_90bb9672b66ac080cdc6da1f5ec341d5 -->
## connector/api/list-users
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-users" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-users"
);
...
### HTTP Request
`GET connector/api/list-users`


<!-- END_90bb9672b66ac080cdc6da1f5ec341d5 -->

<!-- START_850aa0e6311ed7629e012f1b6973c226 -->
## connector/api/list-roles
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-roles" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-roles"
);
...
### HTTP Request
`GET connector/api/list-roles`


<!-- END_850aa0e6311ed7629e012f1b6973c226 -->
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"quis","first_name":"rerum","last_name":"exercitationem","email":"consequatur","is_active":"est","user_type":"maiores","crm_contact_id":7,"allow_login":true,"username":"inventore","password":"sit","role":4,"access_all_locations":true,"location_permissions":[],"cmmsn_percent":"vero","max_sales_discount_percent":"ullam","selected_contacts":false,"selected_contact_ids":[],"dob":"at","gender":"et","marital_status":"consequuntur","blood_group":"aspernatur","contact_number":"quos","alt_number":"numquam","family_number":"totam","fb_link":"quis","twitter_link":"unde","social_media_1":"quo","social_media_2":"sit","custom_field_1":"tempora","custom_field_2":"sunt","custom_field_3":"minima","custom_field_4":"qui","guardian_name":"ratione","id_proof_name":"quae","id_proof_number":"et","permanent_address":"quo","current_address":"saepe","bank_details":[{"account_holder_name":"maiores","account_number":"deserunt","bank_name":"aperiam","bank_code":"temporibus","branch":"doloribus","tax_payer_id":"quisquam"}]}'
...
let body = {
    ...
    "cmmsn_percent": "vero",
    "max_sales_discount_percent": "ullam",
    "selected_contacts": false,
    "selected_contact_ids": [],
    "dob": "at",
    "gender": "et",
    "marital_status": "consequuntur",
    ...
    "social_media_1": "quo",
    "social_media_2": "sit",
    "custom_field_1": "tempora",
    "custom_field_2": "sunt",
    "custom_field_3": "minima",
    "custom_field_4": "qui",
    "guardian_name": "ratione",
    "id_proof_name": "quae",
    "id_proof_number": "et",
    "permanent_address": "quo",
    "current_address": "saepe",
    "bank_details": [
        {
            "account_holder_name": "maiores",
            "account_number": "deserunt",
            "bank_name": "aperiam",
            "bank_code": "temporibus",
            "branch": "doloribus",
            "tax_payer_id": "quisquam"
        }
    ]
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=consequatur" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"sunt","new_password":"sequi"}'
...
<!-- START_077d4fa325547a509bc9ca5b5fc6db1f -->
## connector/api/business-verify
<br><small style="padding: 1px 9px 2px;font-weight: bold;white-space: nowrap;color: #ffffff;-webkit-border-radius: 9px;-moz-border-radius: 9px;border-radius: 9px;background-color: #3a87ad;">Requires authentication</small>
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/business-verify" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/business-verify"
);
...
```json
{
    "error": "Unautharized Action Business"
}
```

### HTTP Request
`GET connector/api/business-verify`


<!-- END_077d4fa325547a509bc9ca5b5fc6db1f -->

<!-- START_b9bd01e08fe50a15515f2105a84ed5ff -->
## connector/api/invoice-schemes
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/invoice-schemes" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/invoice-schemes"
);
...
<!-- END_b9bd01e08fe50a15515f2105a84ed5ff -->

<!-- START_4d1e21dc725eaf85c6480915d1bce6d0 -->
## connector/api/invoice-layouts
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/invoice-layouts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/invoice-layouts"
);
...
### HTTP Request
`GET connector/api/invoice-layouts`


<!-- END_4d1e21dc725eaf85c6480915d1bce6d0 -->

<!-- START_7594d5ae46191807b5e56eb177b915b4 -->
## connector/api/location-permission
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/location-permission" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/location-permission"
);
...
### HTTP Request
`GET connector/api/location-permission`


<!-- END_7594d5ae46191807b5e56eb177b915b4 -->

<!-- START_126fd7a348f686ab06e7067f7d3cb7d5 -->
## connector/api/default-permissions
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/default-permissions" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/default-permissions"
);
    ...
    "data": [
        {
            ...
            "guard_name": "web",
            "created_at": "2022-07-04 11:44:33",
            "updated_at": null
        },
        {
            "id": 2,
        ...
        },
        {
            ...
            "guard_name": "web",
            "created_at": "2022-07-04 11:44:50",
            "updated_at": "2022-07-04 11:44:50"
        },
        {
            "id": 4,
            "name": "crud_all_bookings",
            "guard_name": "web",
            "created_at": "2022-07-04 11:44:56",
            "updated_at": "2022-07-04 11:44:56"
        },
        {
            "id": 5,
        ...
        },
        {
            ...
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:09",
            "updated_at": "2022-07-04 11:45:09"
        },
        {
            "id": 7,
            "name": "purchase.payments",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:14",
            "updated_at": "2022-07-04 11:45:14"
        },
        {
            "id": 8,
            "name": "sell.payments",
        ...
        },
        {
            ...
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:15",
            "updated_at": "2022-07-04 11:45:15"
        },
        {
            "id": 10,
        ...
        },
        {
            ...
            "name": "roles.view",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:18",
            "updated_at": "2022-07-04 11:45:18"
        },
        {
            "id": 12,
            "name": "roles.create",
        ...
        },
        {
            ...
            "name": "account.access",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:22",
            "updated_at": "2022-07-04 11:45:22"
        },
        {
            "id": 16,
            "name": "discount.access",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:23",
            "updated_at": "2022-07-04 11:45:23"
        },
        {
            "id": 17,
            "name": "view_purchase_price",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:36",
            "updated_at": "2022-07-04 11:45:36"
        },
        {
            "id": 18,
            "name": "view_own_sell_only",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:38",
            "updated_at": "2022-07-04 11:45:38"
        },
        {
            "id": 19,
            "name": "edit_product_discount_from_pos_screen",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:46",
            "updated_at": "2022-07-04 11:45:46"
        },
        {
            "id": 20,
        ...
        },
        {
            ...
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:51",
            "updated_at": "2022-07-04 11:45:51"
        },
        {
            "id": 22,
            "name": "purchase.update_status",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:52",
            "updated_at": "2022-07-04 11:45:52"
        },
        {
            "id": 23,
            "name": "list_drafts",
            "guard_name": "web",
            "created_at": "2022-07-04 11:45:57",
            "updated_at": "2022-07-04 11:45:57"
        },
        {
            "id": 24,
        ...
        },
        {
            ...
            "guard_name": "web",
            "created_at": "2022-07-04 11:46:14",
            "updated_at": "2022-07-04 11:46:14"
        },
        {
            "id": 26,
        ...
        },
        {
            ...
            "name": "print_invoice",
            "guard_name": "web",
            "created_at": "2022-07-04 11:46:31",
            "updated_at": "2022-07-04 11:46:31"
        },
        {
            "id": 28,
            "name": "user.view",
            "guard_name": "web",
            "created_at": "2022-07-04 11:47:10",
            "updated_at": null
        },
        {
            "id": 29,
...
### HTTP Request
`GET connector/api/default-permissions`


<!-- END_126fd7a348f686ab06e7067f7d3cb7d5 -->

<!-- START_f147ca4ee55ddf0ffcd9dd79cdbd1bff -->
## connector/api/list-variation-templates
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-variation-templates" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-variation-templates"
);
...
### HTTP Request
`GET connector/api/list-variation-templates`


<!-- END_f147ca4ee55ddf0ffcd9dd79cdbd1bff -->

<!-- START_5f9eed022f7526f21066f32f864a3b85 -->
## connector/api/list-invoice_schemes
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-invoice_schemes" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-invoice_schemes"
);
...
### HTTP Request
`GET connector/api/list-invoice_schemes`


<!-- END_5f9eed022f7526f21066f32f864a3b85 -->

<!-- START_578e1d37af66472543430dad37cf1ee7 -->
## connector/api/list-invoice_layouts
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-invoice_layouts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-invoice_layouts"
);
...
### HTTP Request
`GET connector/api/list-invoice_layouts`


<!-- END_578e1d37af66472543430dad37cf1ee7 -->

<!-- START_f8ca49b4c54a62590404097ef70d6213 -->
## connector/api/list-warranties
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-warranties" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-warranties"
);
...
### HTTP Request
`GET connector/api/list-warranties`


<!-- END_f8ca49b4c54a62590404097ef70d6213 -->

<!-- START_8570dbe3db55d38cd1c568f8302a84d9 -->
## connector/api/list-notification_templates
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/list-notification_templates" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/list-notification_templates"
);
...
### HTTP Request
`GET connector/api/list-notification_templates`


<!-- END_8570dbe3db55d38cd1c568f8302a84d9 -->

<!-- START_c9b202c96223d7ae6098f2a44bb850c8 -->
## connector/api/purchase-transaction
> Example request:

```bash
curl -X GET \
    -G "http://localhost/connector/api/purchase-transaction" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "http://localhost/connector/api/purchase-transaction"
);
...
### HTTP Request
`GET connector/api/purchase-transaction`


<!-- END_c9b202c96223d7ae6098f2a44bb850c8 -->
