...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_in_time":"2000-06-13 13:13:00","clock_in_note":"aut","ip_address":"saepe","latitude":"occaecati","longitude":"nobis"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"user_id":1,"clock_out_time":"2000-06-13 13:13:00","clock_out_note":"culpa","latitude":"fuga","longitude":"error"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/follow-ups?start_date=2020-12-16&end_date=2020-12-16&status=recusandae&follow_up_type=quae&order_by=start_datetime&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"title":"Meeting with client","contact_id":2,"description":"ut","schedule_type":"iure","user_id":"[2,3,5]","notify_before":5,"notify_type":"minute","status":"open","notify_via":"['sms' => 0 ,'mail' => 1]","start_datetime":"2021-01-06 13:05:00","end_datetime":"2021-01-06 13:05:00","followup_additional_info":"['call duration' => '1 hour']","allow_notification":true}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/crm/leads?assigned_to=1%2C2%2C3&name=error&biz_name=in&mobile_num=11&contact_id=debitis&order_by=quo&direction=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"call_logs":[{"mobile_number":"quisquam","mobile_name":"esse","call_type":"call","start_time":"vero","end_time":"et","duration":"eos"}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"initial_amount":1684822.3,"created_at":"2020-5-7 15:20:22","closed_at":"2020-5-7 15:20:22","status":"close","closing_amount":128131.92,"total_card_slips":11,"total_cheques":11,"closing_note":"ut","transaction_ids":"1,2,3"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/contactapi?type=sit&name=iusto&biz_name=similique&mobile_num=5&contact_id=nam&order_by=ratione&direction=aliquid&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"aut","prefix":"dolorum","first_name":"voluptatem","middle_name":"eum","last_name":"harum","tax_number":"8787fefef","pay_term_number":3,"pay_term_type":"months","mobile":"4578691009","landline":"5487-8454-4145","alternate_number":"841847541222","address_line_1":"sit","address_line_2":"culpa","city":"asperiores","state":"sit","country":"voluptatem","zip_code":"culpa","customer_group_id":"magni","contact_id":"accusantium","dob":"2000-06-13","custom_field1":"consequatur","custom_field2":"similique","custom_field3":"impedit","custom_field4":"quibusdam","email":"expedita","shipping_address":"quas","position":"soluta","opening_balance":0,"source_id":13,"life_stage_id":13,"assigned_to":[]}'
...
let body = {
    ...
    "country": "voluptatem",
    "zip_code": "culpa",
    "customer_group_id": "magni",
    "contact_id": "accusantium",
    "dob": "2000-06-13",
    "custom_field1": "consequatur",
    "custom_field2": "similique",
    "custom_field3": "impedit",
    "custom_field4": "quibusdam",
    "email": "expedita",
    "shipping_address": "quas",
    "position": "soluta",
    "opening_balance": 0,
    "source_id": 13,
    "life_stage_id": 13,
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"type":"customer","supplier_business_name":"enim","prefix":"est","first_name":"ab","middle_name":"corporis","last_name":"aut","tax_number":"488744dwd","pay_term_number":3,"pay_term_type":"months","mobile":"8795461009","landline":"65484-848-848","alternate_number":"9898795220","address_line_1":"consequatur","address_line_2":"nemo","city":"deleniti","state":"incidunt","country":"libero","zip_code":"provident","customer_group_id":"praesentium","contact_id":"suscipit","dob":"2000-06-13","custom_field1":"tenetur","custom_field2":"sed","custom_field3":"similique","custom_field4":"doloremque","email":"dolor","shipping_address":"corrupti","position":"quo","opening_balance":10.3,"source_id":20,"life_stage_id":4,"assigned_to":[]}'
...
let body = {
    ...
    "country": "libero",
    "zip_code": "provident",
    "customer_group_id": "praesentium",
    "contact_id": "suscipit",
    "dob": "2000-06-13",
    "custom_field1": "tenetur",
    "custom_field2": "sed",
    "custom_field3": "similique",
    "custom_field4": "doloremque",
    "email": "dolor",
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":17,"amount":453.13,"method":"cash","paid_on":"2020-07-22 15:48:29","account_id":2,"card_number":"dolorum","card_holder_name":"et","card_transaction_number":"minima","card_type":"repellat","card_month":"inventore","card_year":"et","card_security":"incidunt","transaction_no_1":"eaque","transaction_no_2":"corrupti","transaction_no_3":"quia","cheque_number":"quasi","bank_account_number":"at","note":"dolores"}'
...
let body = {
    ...
    "card_number": "dolorum",
    "card_holder_name": "et",
    "card_transaction_number": "minima",
    "card_type": "repellat",
    "card_month": "inventore",
    "card_year": "et",
    "card_security": "incidunt",
    "transaction_no_1": "eaque",
    "transaction_no_2": "corrupti",
    "transaction_no_3": "quia",
    "cheque_number": "quasi",
    "bank_account_number": "at",
    "note": "dolores"
}
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=repellat&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":1,"final_total":47.473286989,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":2,"expense_for":1,"contact_id":18,"expense_category_id":9,"expense_sub_category_id":20,"additional_notes":"consequatur","is_refund":0,"is_recurring":0,"recur_interval":2,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"sint","recur_repetitions":2,"payment":[{"amount":453.13,"method":"cash","account_id":9,"card_number":"sit","card_holder_name":"qui","card_transaction_number":"autem","card_type":"accusantium","card_month":"debitis","card_year":"illum","card_security":"similique","transaction_no_1":"magni","transaction_no_2":"sint","transaction_no_3":"nesciunt","note":"porro","cheque_number":"consectetur"}]}'
    ...
    "payment": [
        {
            ...
            "card_type": "accusantium",
            "card_month": "debitis",
            "card_year": "illum",
            "card_security": "similique",
            "transaction_no_1": "magni",
            "transaction_no_2": "sint",
            "transaction_no_3": "nesciunt",
            "note": "porro",
            "cheque_number": "consectetur"
        }
    ]
}
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":51.01,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":19,"expense_for":13,"contact_id":9,"expense_category_id":10,"expense_sub_category_id":2,"additional_notes":"molestias","is_recurring":0,"recur_interval":3,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"velit","recur_repetitions":1,"payment":[]}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/expense-refund?location_id=1&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=voluptas&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/field-force?contact_id=illo&assigned_to=id&status=consectetur&start_date=2018-06-25&end_date=2018-06-25&per_page=15&order_by_date=desc" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":6,"visit_to":"iusto","visit_address":"et","assigned_to":6,"visit_on":"2021-12-28 17:23:00","visit_for":"quis"}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"status":"finished","reason_to_not_meet_contact":"cum","visited_on":"2021-12-28 17:23:00","visited_address":"Radhanath Mullick Ln, Tiretta Bazaar, Bow Bazaar, Kolkata, West Bengal, 700 073, India","latitude":"41.40338","longitude":"2.17403","comments":"eligendi","photo":"et"}'
...
let body = {
    "status": "finished",
    "reason_to_not_meet_contact": "cum",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product?order_by=ad&order_direction=nemo&brand_id=aut&category_id=est&sub_category_id=rerum&location_id=1&selling_price_group=et&send_lot_detail=dolor&name=assumenda&sku=cum&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    "order_by": "ad",
    "order_direction": "nemo",
    "brand_id": "aut",
    "category_id": "est",
    "sub_category_id": "rerum",
    "location_id": "1",
    "selling_price_group": "et",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/product/1?selling_price_group=nihil&send_lot_detail=ut" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/variation/2?product_id=et&location_id=1&brand_id=accusamus&category_id=amet&sub_category_id=assumenda&not_for_selling=nobis&name=voluptatem&sku=sunt&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell?location_id=1&contact_id=nesciunt&payment_status=due%2Cpartial&start_date=2018-06-25&end_date=2018-06-25&user_id=commodi&service_staff_id=aut&shipping_status=ordered&source=magni&only_subscriptions=laborum&send_purchase_details=provident&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "commodi",
    "service_staff_id": "aut",
    "shipping_status": "ordered",
    "source": "magni",
    "only_subscriptions": "laborum",
    "send_purchase_details": "provident",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":1,"contact_id":14,"transaction_date":"2020-07-22 15:48:29","invoice_no":"laborum","source":"api, phone, woocommerce","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"perferendis","staff_note":"omnis","commission_agent":10,"shipping_details":"Express Delivery","shipping_address":"libero","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":12,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":18,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"iste","recur_repetitions":12,"rp_redeemed":16,"rp_redeemed_amount":13.5,"types_of_service_id":19,"service_custom_field_1":"fuga","service_custom_field_2":"atque","service_custom_field_3":"iusto","service_custom_field_4":"quia","service_custom_field_5":"placeat","service_custom_field_6":"nihil","round_off_amount":1,"table_id":18,"service_staff_id":9,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":18,"note":"debitis"}],"payments":[{"amount":453.13,"method":"cash","account_id":17,"card_number":"reiciendis","card_holder_name":"ipsum","card_transaction_number":"facere","card_type":"fugiat","card_month":"voluptatem","card_year":"enim","card_security":"magnam","transaction_no_1":"est","transaction_no_2":"pariatur","transaction_no_3":"deleniti","bank_account_number":"quidem","note":"non","cheque_number":"quis"}]}]}'
    ...
    "sells": [
        {
            ...
            "discount_amount": 10,
            "discount_type": "fixed",
            "sale_note": "perferendis",
            "staff_note": "omnis",
            "commission_agent": 10,
            "shipping_details": "Express Delivery",
            "shipping_address": "libero",
            "shipping_status": "ordered",
            ...
            "service_custom_field_1": "fuga",
            "service_custom_field_2": "atque",
            "service_custom_field_3": "iusto",
            "service_custom_field_4": "quia",
            "service_custom_field_5": "placeat",
            "service_custom_field_6": "nihil",
            "round_off_amount": 1,
            "table_id": 18,
            "service_staff_id": 9,
            "change_return": 0,
            ...
            "payments": [
                {
                    ...
                    "method": "cash",
                    "account_id": 17,
                    "card_number": "reiciendis",
                    "card_holder_name": "ipsum",
                    "card_transaction_number": "facere",
                    "card_type": "fugiat",
                    "card_month": "voluptatem",
                    "card_year": "enim",
                    "card_security": "magnam",
                    "transaction_no_1": "est",
                    "transaction_no_2": "pariatur",
                    "transaction_no_3": "deleniti",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/sell/55?send_purchase_details=nam" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X PUT \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":18,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"beatae","source":"ipsam","staff_note":"eveniet","is_suspend":false,"commission_agent":9,"shipping_details":"Express Delivery","shipping_address":"sint","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":13,"pay_term_number":5,"pay_term_type":"months","is_recurring":0,"recur_interval":11,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"velit","recur_repetitions":16,"rp_redeemed":13,"rp_redeemed_amount":13.5,"types_of_service_id":19,"service_custom_field_1":"ipsum","service_custom_field_2":"autem","service_custom_field_3":"quasi","service_custom_field_4":"sit","service_custom_field_5":"quo","service_custom_field_6":"itaque","round_off_amount":3.60901,"table_id":15,"service_staff_id":10,"change_return":0,"change_return_id":20,"products":[{"sell_line_id":16,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":17,"discount_amount":0,"discount_type":"percentage","sub_unit_id":6,"note":"enim"}],"payments":[{"payment_id":16,"amount":453.13,"method":"cash","account_id":11,"card_number":"est","card_holder_name":"nisi","card_transaction_number":"sunt","card_type":"corporis","card_month":"enim","card_year":"magnam","card_security":"reiciendis","transaction_no_1":"aut","transaction_no_2":"laudantium","transaction_no_3":"velit","note":"nobis","cheque_number":"et","bank_account_number":"fuga"}]}'
...
let body = {
    ...
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 19,
    "service_custom_field_1": "ipsum",
    "service_custom_field_2": "autem",
    "service_custom_field_3": "quasi",
    "service_custom_field_4": "sit",
    "service_custom_field_5": "quo",
    "service_custom_field_6": "itaque",
    "round_off_amount": 3.60901,
    "table_id": 15,
    "service_staff_id": 10,
    "change_return": 0,
    "change_return_id": 20,
    ...
    "payments": [
        {
            ...
            "transaction_no_1": "aut",
            "transaction_no_2": "laudantium",
            "transaction_no_3": "velit",
            "note": "nobis",
            "cheque_number": "et",
            "bank_account_number": "fuga"
        }
    ]
}
...
```bash
curl -X DELETE \
    "http://localhost/connector/api/sell/eius" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":11,"transaction_date":"2020-5-7 15:20:22","invoice_no":"impedit","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":17,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":2,"shipping_status":"ordered","delivered_to":"velit"}'
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/taxonomy?type=commodi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"surname":"asperiores","first_name":"cumque","last_name":"eligendi","email":"sit","is_active":"velit","user_type":"quas","crm_contact_id":20,"allow_login":true,"username":"at","password":"dicta","role":14,"access_all_locations":false,"location_permissions":[],"cmmsn_percent":"ut","max_sales_discount_percent":"officia","selected_contacts":true,"selected_contact_ids":[],"dob":"error","gender":"aut","marital_status":"accusamus","blood_group":"sequi","contact_number":"velit","alt_number":"pariatur","family_number":"vel","fb_link":"et","twitter_link":"minus","social_media_1":"deleniti","social_media_2":"dolorum","custom_field_1":"rerum","custom_field_2":"fugit","custom_field_3":"voluptas","custom_field_4":"totam","guardian_name":"rerum","id_proof_name":"eaque","id_proof_number":"velit","permanent_address":"et","current_address":"optio","bank_details":[{"account_holder_name":"dicta","account_number":"voluptatem","bank_name":"recusandae","bank_code":"voluptatem","branch":"omnis","tax_payer_id":"fugit"}]}'
...
let body = {
    ...
    "cmmsn_percent": "ut",
    "max_sales_discount_percent": "officia",
    "selected_contacts": true,
    "selected_contact_ids": [],
    "dob": "error",
    "gender": "aut",
    "marital_status": "accusamus",
    "blood_group": "sequi",
    "contact_number": "velit",
    "alt_number": "pariatur",
    "family_number": "vel",
    "fb_link": "et",
    "twitter_link": "minus",
    "social_media_1": "deleniti",
    "social_media_2": "dolorum",
    "custom_field_1": "rerum",
    "custom_field_2": "fugit",
    "custom_field_3": "voluptas",
    "custom_field_4": "totam",
    "guardian_name": "rerum",
    "id_proof_name": "eaque",
    "id_proof_number": "velit",
    "permanent_address": "et",
    "current_address": "optio",
    "bank_details": [
        {
            "account_holder_name": "dicta",
            "account_number": "voluptatem",
...
```bash
curl -X GET \
    -G "http://localhost/connector/api/user?service_staff=dolor" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"molestiae","new_password":"incidunt"}'
